...
;proj11 adding score
;proj13 adding music
;proj14 some fixes, welcome screen, text etc
...
kbisr:		
            ...
            cmp al, 0x2a          ; Check if the key pressed is he w key.
			jne nextcmp									; no, try next comparison
            mov word[cs:jumpflagkbisr], 1
           
			          
			jmp nomatch									; leave interrupt routine

nextcmp:	cmp al, 0x31								; is the key esc
            jne nextcmp1
			mov word[cs:escflag], 1							; no, leave interrupt routine
			;call clrscr1
		
            jmp nomatch
nextcmp1:  
 cmp al, 0x19								;cmp resume key
            jne nomatch								; no, leave interrupt routine
			 mov word [cs:resumeflag], 1
            jmp nomatch			
...
platformdirectionflag: dw 0 ; lowest platform
platform2directionflag: dw 0 ; top platform
platform3directionflag: dw 1 ; middle platform
platformcolor: dw 46
